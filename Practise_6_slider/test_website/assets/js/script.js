...
var slide1 = new Slide(
   ...
   "Познакомьтесь с лучшим туроператором по Азии!",
   "../assets/img/first_slide.jpg",
   "about.html"
);


var slide2 = new Slide(
   "Работаем с лучшими авиакомпаниями",
   "Ваша безопасность - наш приоритет!",
   "../assets/img/second_slide.jpg",
   "https://www.airhelp.com/ru/airhelp-score/reiting-avialinii/"
);

var slide3 = new Slide(
"Остались вопросы?",
"Заполните форму и наш работник свяжется с Вами",
"../assets/img/third_slide.jpg",
"contact.html"
);
...
function buildSlider(){
   ...
   for(var i = 0; i < slideArray.length; i++) {
       myHTML += "<div id='" + slideArray[i].id +
           ...
           "<a class='slider' href='" + slideArray[i].link + "' target='_blank'>Детальнее</a>" +
           "</div>" +
           "</div>";
   }
